...
class RecipeAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val titleTypeFace = ResourcesCompat.getFont(context, R.font.runic)
        titleTextView.typeface = titleTypeFace

        val subtitleTypeFace = ResourcesCompat.getFont(context, R.font.runic)
        subtitleTextView.typeface = subtitleTypeFace

        val detailsTypeFace = ResourcesCompat.getFont(context, R.font.runic)
